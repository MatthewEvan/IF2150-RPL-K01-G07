...
| A05 | Membuka Halaman Rangkuman Kasus | Pengguna membuka satu halaman rangkuman yang menyajikan inti masalah, hak, langkah solusi, dokumen, templat, artikel, dan disklaimer dalam satu tampilan. | US-02 |
...
| R55 | A20 | Business | Akun Administrator awal tidak dibuat melalui antarmuka aplikasi, melainkan disemai langsung oleh tim pengembang saat deployment melalui skrip seeding basis data (proses otomatis satu kali, bukan input manual). Minimal disediakan dua akun Administrator agar proses peninjauan konten tetap berjalan bila salah satu kehilangan akses. | Tidak |
